export default function InvestorRelationsPage() {
  const s = {
    wrap: { fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif", maxWidth: 900, margin: "0 auto", padding: "0 1rem 3rem", background: "#0d0f16" },
    ...
    toc: { background: "rgba(255,255,255,0.06)", backdropFilter: "blur(20px)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: 12, padding: "1.5rem 2rem", marginBottom: "2rem" },
    tocLabel: { fontSize: "0.7rem", fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", color: "rgba(255,255,255,0.4)", marginBottom: "1rem" },
    tocGrid: { display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "0.4rem 1rem" },
    tocLink: { fontSize: "0.82rem", color: "#3b82f6", textDecoration: "none", display: "flex", alignItems: "center", gap: 5 },
    card: { background: "rgba(255,255,255,0.06)", backdropFilter: "blur(20px)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: 12, padding: "2rem 2.5rem", marginBottom: "1.5rem" },
    sectionLabel: { fontSize: "0.7rem", fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", color: "rgba(255,255,255,0.4)", display: "flex", alignItems: "center", gap: 10, marginBottom: "0.75rem" },
    sectionLine: { flex: 1, height: 1, background: "rgba(255,255,255,0.1)", display: "inline-block" },
    cardH2: { fontSize: "1.35rem", fontWeight: 800, color: "#ffffff", margin: "0 0 1rem", letterSpacing: "-0.01em" },
    cardP: { fontSize: "0.9rem", color: "rgba(255,255,255,0.7)", lineHeight: 1.8, margin: "0 0 0.85rem" },
    cardPLast: { fontSize: "0.9rem", color: "rgba(255,255,255,0.7)", lineHeight: 1.8, margin: 0 },
    highlight: { background: "rgba(59,130,246,0.1)", borderLeft: "3px solid #3b82f6", borderRadius: "0 8px 8px 0", padding: "1rem 1.25rem", marginTop: "1.25rem" },
    highlightStrong: { color: "#ffffff", fontWeight: 700, fontSize: "0.875rem", display: "block", marginBottom: 4 },
    highlightP: { fontSize: "0.875rem", color: "rgba(255,255,255,0.7)", margin: 0, lineHeight: 1.7 },
    stats: { display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "1rem", margin: "1.25rem 0" },
    stat: { background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: 10, padding: "1rem 1.25rem", textAlign: "center" },
    statValue: { fontSize: "1.6rem", fontWeight: 800, color: "#ffffff", letterSpacing: "-0.03em", lineHeight: 1, marginBottom: "0.25rem" },
    statAccent: { color: "#3b82f6" },
    statLabel: { fontSize: "0.72rem", color: "rgba(255,255,255,0.5)", fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.06em" },
    pillars: { display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: "0.85rem", marginTop: "1.25rem" },
    pillar: { background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: 8, padding: "0.9rem 1.1rem", display: "flex", alignItems: "flex-start", gap: 10 },
    pillarIcon: { width: 36, height: 36, minWidth: 36, background: "rgba(59,130,246,0.15)", borderRadius: 8, display: "flex", alignItems: "center", justifyContent: "center", fontSize: "1rem", lineHeight: 1 },
    pillarTitle: { fontSize: "0.82rem", fontWeight: 700, color: "#ffffff", display: "block", marginBottom: 2 },
    pillarDesc: { fontSize: "0.78rem", color: "rgba(255,255,255,0.5)", lineHeight: 1.5 },
    ...
    footer: { textAlign: "center", fontSize: "0.78rem", color: "rgba(255,255,255,0.4)", paddingTop: "0.5rem", paddingBottom: "1rem" },
  };
