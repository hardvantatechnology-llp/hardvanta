...
export default async function CustomersPage({ searchParams }) {
  ...
  return (
    <div>
      ...
      <div className="mb-4">
        <AdminSearchInput placeholder="Search by name or email…" basePath="/admin/customers" searchParams={searchParams} />
      </div>
      ...
      <Pagination page={page} totalPages={totalPages} basePath="/admin/customers" searchParams={searchParams} />
    </div>
  );
}
