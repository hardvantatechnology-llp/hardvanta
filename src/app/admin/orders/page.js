  ...
  return (
    <div>
      ...
      <div className="mb-4 flex flex-wrap items-center gap-3">
        <AdminSearchInput placeholder="Search by customer name or email…" basePath="/admin/orders" searchParams={searchParams} />
      ...
      <Pagination page={page} totalPages={totalPages} basePath="/admin/orders" searchParams={searchParams} />
    </div>
  );
}
