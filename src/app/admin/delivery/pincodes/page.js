...
export default async function PincodesPage({ searchParams }) {
  ...
  return (
    <div>
      ...
      <div className="mb-4">
        <AdminSearchInput placeholder="Search by pincode, locality or city…" basePath="/admin/delivery/pincodes" searchParams={searchParams} />
      </div>
      ...
      <Pagination page={page} totalPages={totalPages} basePath="/admin/delivery/pincodes" searchParams={searchParams} />
    </div>
  );
}
