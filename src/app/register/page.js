  ...
  return (
    ...
    >
        <button
          ...
          className="mt-6 flex w-full items-center justify-center gap-3 rounded-xl glass-card py-2.5 text-sm font-semibold text-white hover:shadow-glow-electric transition-all"
        >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label htmlFor="register-name" className="mb-1 block text-sm font-medium text-white/80">
              Name
            </label>
            <input
              id="register-name"
          ...
          <div>
            <label htmlFor="register-email" className="mb-1 block text-sm font-medium text-white/80">
              Email
            </label>
            <input
              id="register-email"
          ...
          <div>
            <label htmlFor="register-phone" className="mb-1 block text-sm font-medium text-white/80">
              Mobile number
            </label>
          ...
          <div>
            <label htmlFor="register-password" className="mb-1 block text-sm font-medium text-white/80">
              Password
            </label>
